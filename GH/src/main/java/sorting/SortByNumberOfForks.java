...
/**
 * This class provides the means to sort a list of repositories based on the number of forks
 */
public class SortByNumberOfForks extends SortingMethod {

      /**
     * Returns a list of GHRepository objects sorted in descending order based on the number of forks.
